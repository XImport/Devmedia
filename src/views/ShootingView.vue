          ...
          <div class="row">
            <div class="col-md-12">
              <div class="section_title text-center" data-aos="fade-up">
                <h2 class="white--text">Shooting Images</h2>
...
export default {
  metaInfo: {
    title: "Devmedia",
    titleTemplate: "%s | Shooting Images ",
  },
  data() {
    return {
      contents: [
        {
          title: "Shooting Images",
